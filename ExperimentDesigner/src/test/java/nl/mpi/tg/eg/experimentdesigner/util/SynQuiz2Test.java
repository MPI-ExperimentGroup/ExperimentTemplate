 ...
 */
public class SynQuiz2Test {

    public SynQuiz2Test() {
    }

    /**
     * Test of getExperiment method, of class SynQuiz2.
     *
    ...
    public void testGetExperiment() throws IOException, JAXBException, URISyntaxException {
        ...
        SynQuiz2 instance = new SynQuiz2();
...
//        jaxbMarshaller.marshal(result, System.out);
        jaxbMarshaller.marshal(result, new File(new File(testXmlUri).getParentFile(), "synquiz2-testoutput.xml"));
