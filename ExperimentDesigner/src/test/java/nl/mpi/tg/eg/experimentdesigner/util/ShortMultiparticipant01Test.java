 ...
 */
public class ShortMultiparticipant01Test {

    /**
     * Test of getExperiment method, of class ShortMultiparticipant01.
     *
    ...
    public void testGetWizardData() throws IOException, JAXBException, URISyntaxException {
        ...
        ShortMultiparticipant01 instance = new ShortMultiparticipant01();
        URI testXmlUri = this.getClass().getResource("/frinex-rest-output/shortmultiparticipant01.xml").toURI();
...
//        jaxbMarshaller.marshal(result, System.out);
        jaxbMarshaller.marshal(result, new File(new File(testXmlUri).getParentFile(), "shortmultiparticipant01-testoutput.xml"));
