 ...
 */
public class HRPretestTest {

    public HRPretestTest() {
    }
    ...
    public void testGetWizardData() throws IOException, JAXBException, URISyntaxException {
        ...
        HRPretest instance = new HRPretest();
        URI testXmlUri = this.getClass().getResource("/frinex-rest-output/hrpretest.xml").toURI();
...
//        jaxbMarshaller.marshal(result, System.out);
        jaxbMarshaller.marshal(result, new File(new File(testXmlUri).getParentFile(), "hrpretest-testoutput.xml"));
