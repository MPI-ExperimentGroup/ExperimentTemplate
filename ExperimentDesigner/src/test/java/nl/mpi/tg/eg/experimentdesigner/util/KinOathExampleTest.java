 ...
 */
public class KinOathExampleTest {

    public KinOathExampleTest() {
    }
    ...
    public void testGetExperiment() throws IOException, JAXBException, URISyntaxException {
        ...
        KinOathExample instance = new KinOathExample();
        URI testXmlUri = this.getClass().getResource("/frinex-rest-output/kinoath.xml").toURI();
...
//        jaxbMarshaller.marshal(result, System.out);
        jaxbMarshaller.marshal(result, new File(new File(testXmlUri).getParentFile(), "kinoath-testoutput.xml"));
