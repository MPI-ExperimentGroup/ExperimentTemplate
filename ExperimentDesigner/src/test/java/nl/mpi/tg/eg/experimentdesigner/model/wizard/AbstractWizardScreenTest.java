...
public class AbstractWizardScreenTest {
    ...
    protected static AbstractWizardScreen[] getInstance() {
        return new AbstractWizardScreen[]{
            ...
            new WizardMultiParticipantScreen("screenName", "groupMembers", "communicationChannels", "textEntryPhaseRoles", "textEntryPhaseText", "textWaitPhaseRoles", true, "textWaitPhaseText", "gridWaitPhaseRoles", "gridWaitPhaseText", "responseGridPhaseRoles", "responseGridPhaseText", "mutualFeedbackPhaseRoles", "mutualFeedbackPhaseText", "trainingDisplayPhaseRoles", "trainingDisplayPhaseText", "preStimuliText", "postStimuliText", 0, 0, 0, 0, "timerCountDownLabel")
        };
    }
