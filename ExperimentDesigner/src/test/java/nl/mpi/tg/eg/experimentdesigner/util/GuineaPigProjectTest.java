 ...
 */
public class GuineaPigProjectTest {

    public GuineaPigProjectTest() {
    }
    ...
    public void testGetWizardData() throws IOException, JAXBException, URISyntaxException {
        ...
        GuineaPigProject instance = new GuineaPigProject();
        URI testXmlUri = this.getClass().getResource("/frinex-rest-output/guineapigproject01.xml").toURI();
...
//        jaxbMarshaller.marshal(result, System.out);
        jaxbMarshaller.marshal(result, new File(new File(testXmlUri).getParentFile(), "guineapigproject01-testoutput.xml"));
