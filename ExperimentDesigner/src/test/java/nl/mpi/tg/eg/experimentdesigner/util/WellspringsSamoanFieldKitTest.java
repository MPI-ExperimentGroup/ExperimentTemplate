 ...
 */
public class WellspringsSamoanFieldKitTest {

    public WellspringsSamoanFieldKitTest() {
    }

    /**
     * Test of getExperiment method, of class WellspringsSamoanFieldKit.
     *
    ...
    public void testGetExperiment() throws IOException, JAXBException, URISyntaxException {
        ...
        WellspringsSamoanFieldKit instance = new WellspringsSamoanFieldKit();
        URI testXmlUri = this.getClass().getResource("/frinex-rest-output/wellspringssamoanfieldkit.xml").toURI();
...
//        jaxbMarshaller.marshal(result, System.out);
        jaxbMarshaller.marshal(result, new File(new File(testXmlUri).getParentFile(), "wellspringssamoanfieldkit-testoutput.xml"));
