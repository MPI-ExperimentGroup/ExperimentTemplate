...
/**
 * @since Aug 22, 2016 3:43:12 PM (creation date)
 * @author Peter Withers <peter.withers@mpi.nl>
 */
public class RdExperiment02Test {

    public RdExperiment02Test() {
    }

    /**
     * Test of getWizardData method, of class RdExperiment02.
     */
    @Ignore
    @Test
    public void testGetWizardData() throws IOException, JAXBException, URISyntaxException {
        System.out.println("getWizardData");
        RdExperiment02 instance = new RdExperiment02();
        URI testXmlUri = this.getClass().getResource("/frinex-rest-output/zinnen_afmaken.xml").toURI();
...
//        jaxbMarshaller.marshal(result, System.out);
        jaxbMarshaller.marshal(result, new File(new File(testXmlUri).getParentFile(), "zinnen_afmaken-testoutput.xml"));
