 ...
 */
public class RosselFieldKitTest {

    public RosselFieldKitTest() {
    }
    ...
    public void testGetExperiment() throws IOException, JAXBException, URISyntaxException {
        ...
        RosselFieldKit instance = new RosselFieldKit();
        URI testXmlUri = this.getClass().getResource("/frinex-rest-output/rosselfieldkit.xml").toURI();
...
//        jaxbMarshaller.marshal(result, System.out);
        jaxbMarshaller.marshal(result, new File(new File(testXmlUri).getParentFile(), "rosselfieldkit-testoutput.xml"));
