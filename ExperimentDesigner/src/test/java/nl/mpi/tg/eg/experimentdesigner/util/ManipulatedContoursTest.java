...
/**
 * @since Nov 7, 2016 1:37:49 PM (creation date)
 * @author Peter Withers <peter.withers@mpi.nl>
 */
public class ManipulatedContoursTest {
    ...
    public void testGetWizardData() throws IOException, JAXBException, URISyntaxException {
        ...
        ManipulatedContours instance = new ManipulatedContours();
        URI testXmlUri = this.getClass().getResource("/frinex-rest-output/manipulated_contours.xml").toURI();
...
//        jaxbMarshaller.marshal(result, System.out);
        jaxbMarshaller.marshal(result, new File(new File(testXmlUri).getParentFile(), "manipulated_contours-testoutput.xml"));
