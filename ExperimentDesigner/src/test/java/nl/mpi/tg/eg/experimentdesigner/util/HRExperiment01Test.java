 ...
 */
public class HRExperiment01Test {

    public HRExperiment01Test() {
    }
    ...
    public void testGetWizardData() throws IOException, JAXBException, URISyntaxException {
        ...
        URI testXmlUri = this.getClass().getResource("/frinex-rest-output/hrexperiment01.xml").toURI();
...
//        jaxbMarshaller.marshal(result, System.out);
        jaxbMarshaller.marshal(result, new File(new File(testXmlUri).getParentFile(), "hrexperiment01-testoutput.xml"));
