...
//        wizardData.setCustomTextField("level of proficiency in Dutch");
        ...
        final PresenterScreen editUserScreen = wizardController.addEditUserScreen(experiment, null, "Participant", null, 2, wizardData, null, medataFields, "Volgende", null, null, null, wizardData.isObfuscateScreenNames());
        final PresenterScreen groupAorBScreen = wizardController.addRandomTextScreen(experiment, null, 3, "Introduciton", false, stimuliGroupAorB,
                new String[]{"IntroductionAFact", "IntroductionBFiction"}, 1, null, 0, 0, null, null, null, null, "volgende [ spatiebalk ]", wizardData.isObfuscateScreenNames());
//        final PresenterScreen storyScreen = wizardController.addRandomTextScreen(experiment, null, 4, "StoryPresentation", false, storyTexts, new String[]{"Emotioneel_hij", "Emotioneel_ik", "Koffiemolen_hij", "Koffiemolen_ik", "Matroesjka_hij", "Matroesjka_ik", "Meesterwerk_hij", "Meesterwerk_ik"}, 1, null, 0, 0, null, null, null, null, wizardData.isObfuscateScreenNames());
        final PresenterScreen storyScreen = wizardController.addRandomTextScreen(experiment, null, 4, "StoryPresentation", false, storyTexts, new String[]{"Emotioneel_hij", "Emotioneel_ik", "Koffiemolen_hij", "Koffiemolen_ik", "Matroesjka_hij", "Matroesjka_ik", "Meesterwerk_hij", "Meesterwerk_ik"}, 1, null, 0, 0, null, null, null, null, "volgende [ spatiebalk ]", wizardData.isObfuscateScreenNames());
