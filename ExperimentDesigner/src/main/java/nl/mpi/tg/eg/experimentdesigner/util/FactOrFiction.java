...
//        wizardData.setCustomTextField("level of proficiency in Dutch");
        ...
        final PresenterScreen editUserScreen = wizardController.addEditUserScreen(experiment, null, "Participant", null, 2, wizardData, null, medataFields, "Volgende", null, null, null, "Could not contact the server, please check your internet connection and try again.", wizardData.isObfuscateScreenNames());
...
//        final PresenterScreen storyScreen = wizardController.addRandomTextScreen(experiment, null, 4, "StoryPresentation", false, storyTexts, new String[]{"Emotioneel_hij", "Emotioneel_ik", "Koffiemolen_hij", "Koffiemolen_ik", "Matroesjka_hij", "Matroesjka_ik", "Meesterwerk_hij", "Meesterwerk_ik"}, 1, null, 0, 0, null, null, null, null, wizardData.isObfuscateScreenNames());
        ...
        final PresenterScreen survey1InstructionsScreen = wizardController.addTextScreen(experiment, null, "Survey1Instructions", null, 16, "<b>U krijgt nu enkele stellingen te zien over uw ervaringen tijdens het lezen van het voorgaande verhaal. Geef aan in hoeverre de stellingen van toepassing zijn op uw ervaring tijdens het lezen van dit verhaal.</b>", "volgende [ spatiebalk ]", wizardData.isObfuscateScreenNames());
        ...
        final PresenterScreen submitDataScreen = wizardController.addSubmitDataScreen(experiment, null, null, 20, "SubmitData", "Could not contact the server, please check your internet connection and try again.", "Retry", wizardData.isObfuscateScreenNames());
        final PresenterScreen restartScreen = wizardController.addCompletionScreen(experiment, null, null, 22, "Wil nog iemand op dit apparaat deelnemen aan dit onderzoek, klik dan op de onderstaande knop.", true, "Opnieuw beginnen", "Completion", "Could not contact the server, please check your internet connection and try again.", "Retry", wizardData.isObfuscateScreenNames());
        final PresenterScreen registeredScreen = wizardController.addCompletionScreen(experiment, null, null, 23, "Leuk dat u geïnteresseerd bent. Wil nog iemand op dit apparaat deelnemen aan dit onderzoek, klik dan op de onderstaande knop.", true, "Opnieuw beginnen", "Registered", "Could not contact the server, please check your internet connection and try again.", "Retry", wizardData.isObfuscateScreenNames());
        final PresenterScreen completionScreen = wizardController.addEditUserScreen(experiment, null, "Bedankt", null, 21, null, completionScreenText, new String[]{"emaill::^[^@]+@[^@]+$:Geef een geldig e-mailadres."}, "Registreren", "Nog een keer meedoen?", restartScreen, "Ja graag!", "Could not contact the server, please check your internet connection and try again.", wizardData.isObfuscateScreenNames());
