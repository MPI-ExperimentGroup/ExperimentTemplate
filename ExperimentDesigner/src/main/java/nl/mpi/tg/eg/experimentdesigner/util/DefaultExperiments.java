...
//        experimentRepository.save(new SentenceCompletion(new Joost02()).getExperiment());
        ...
        for (Experiment experiment : experimentRepository.findAll()) {
            eventRepository.save(new PublishEvents(experiment, new Date(), new Date(), PublishEvents.PublishState.validate, true, false, false, false, false, null, null));
        }
    }
    ...
    public Experiment getAllOptionsExperiment(MetadataRepository metadataRepository, PresenterFeatureRepository presenterFeatureRepository, PresenterScreenRepository presenterScreenRepository) {
        ...
        experiment.getPublishEvents().add(new PublishEvents(experiment, datePublished.getTime(), dateExpired.getTime(), PublishEvents.PublishState.validate, true, true, true, true, true, null, null));
