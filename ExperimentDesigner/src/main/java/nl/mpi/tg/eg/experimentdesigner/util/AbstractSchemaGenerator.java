                        ...
                        new DocumentationElement[]{
                            ...
                            new DocumentationElement("dataTable", "dataTable", "When present defines a table that will be displayed on the main page of the experiment admin. Multiple table can be used.", 0, 0,
                                    new DocumentationElement[]{
                                        ...
                                        //                                                .stringAttribute("fieldName", false)
                                        //                                                .documentedAttribute("matching", AttributeType.xsString, "Only records matching this string will be counted for this dataset. The percent sign will match zero, one, or multiple characters. The underscore will match any single character.", false),
                                        new DocumentationElement("stimulusResponse", "stimulusResponseTable", "Adds matching stimuli responses as a dataset to the table.", 0, 0, new DocumentationElement[0])
                                                ...
                                                .documentedAttribute("dataChannel", AttributeType.xsString, "Only records matching this dataChannel will be included for this dataset. The percent sign will match zero, one, or multiple characters. The underscore will match any single character.", false)
                                                .documentedAttribute("responseGroup", AttributeType.xsString, "Only records matching this responseGroup will be included for this dataset. The percent sign will match zero, one, or multiple characters. The underscore will match any single character.", false)
                                                .documentedAttribute("scoreGroup", AttributeType.xsString, "Only records matching this scoreGroup will be included for this dataset. The percent sign will match zero, one, or multiple characters. The underscore will match any single character.", false)
                                                .documentedAttribute("stimulusID", AttributeType.xsString, "Only records matching this stimulusID will be included for this dataset. The percent sign will match zero, one, or multiple characters. The underscore will match any single character.", false)
                                                .documentedAttribute("isCorrect", AttributeType.xsString, "Only records matching this isCorrect will be included for this dataset. The percent sign will match zero, one, or multiple characters. The underscore will match any single character.", false),
