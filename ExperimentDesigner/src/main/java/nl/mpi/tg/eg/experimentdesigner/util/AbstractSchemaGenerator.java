    ...
    protected final DocumentationElement rootElement = new DocumentationElement("experiment", "Each experiment XML configuration file must have one \"experiment\" element of which only one is permitted and it must contain all other elements of the configuration file.", 1, 1,
            new DocumentationElement[]{
                ...
                new DocumentationElement("deployment", "", 0, 1,
                        ...
                        .booleanAttribute("isVirtualReality", true, "Experimental feature, if true an UnrealEngine version of this experiment will be generated.")
                ...
                new DocumentationElement("administration", "Administration", 0, 1,
                        new DocumentationElement[]{
                            ...
                            new DocumentationElement("dataAgreementField", "When present the named metadata field is used to prevent specific data types from being sent to the server until the agreement field matches the required value.", 0, 1, new DocumentationElement[0])
                            ...
                            new DocumentationElement("chart", "adminChart", "When present defines a chart that will be displayed on the main page of the experiment admin. Multiple charts can be used.", 0, 0,
                                    new DocumentationElement[]{
                                        new DocumentationElement("dataset", "Adds dataset to the graph.", 0, 0, new DocumentationElement[0])
                                                .stringAttribute("label", false)
...
//                                                .colourRGBAttribute("colour", false)
                            ...
                            new DocumentationElement("dataTable", "dataTable", "When present defines a table that will be displayed on the main page of the experiment admin.", 0, 0, new DocumentationElement[0])
//                                    new DocumentationElement[]{
                                        ...
                                        //                                                .documentedAttribute("matching", AttributeType.xsString, "Only records matching this string will be counted for this dataset. The percent sign will match zero, one, or multiple characters. The underscore will match any single character.", false),
                                    .stringAttribute("label", false)
                                    .restrictedAttribute("source", null, "The data source for the table.", false, "stimulusResponse", "tagpair", "tagdata", "metadata", "timestamp", "mediaResponse")
...
//                                    .documentedAttribute("tagValue2", AttributeType.xsString, "Only records matching this TagValue2 will be included for this dataset. The percent sign will match zero, one, or multiple characters. The underscore will match any single character.", true),
                                    .documentedAttribute("matching", AttributeType.xsString, "Only records matching this query will be counted for this dataset. The query consists of a column name or fieldName followed by = and the search string. Multiple colums or fieldNames can be queried when separated by ;. The percent sign will match zero, one, or multiple characters. The underscore will match any single character.", true)
                        })
                        ...
                        .documentedAttribute("securityGroup", AttributeType.xsString, "This determines who can access to the production administration system. You will have been given an ActiveDirectory group name by system admin and only users in this group can log in to the administration system for this experiment.", true)
                ...
                new DocumentationElement("presenter", "Each screen in an experiment configuration is described in a PRESENTER element.", 1, 0)
                        .documentedAttribute("self", AttributeType.presenterName, "The name of the presenter, which must be unique per configuration file.", true)
                        .stringAttribute("title", true)
                        .stringAttribute("menuLabel", true)
                        ...
                        .presenterNameAttribute("next", "If the next attribute is provided the next button will be shown. This attribute is also used as the target for gotoNextPresenter, selectUserMenu and activateRandomItem.", true)
            ...
            .colourRGBAttribute("complementColour2", true)
            .colourRGBAttribute("complementColour3", true)
            .colourRGBAttribute("complementColour4", true)
            .colourRGBAttribute("primaryColour0", true)
            .colourRGBAttribute("primaryColour1", true)
            .colourRGBAttribute("primaryColour2", true)
            .colourRGBAttribute("primaryColour3", true)
            .colourRGBAttribute("primaryColour4", true)
            ...
            .booleanAttribute("isScalable", true, "Boolean")
            // TODO: preserveLastState would perhaps be better renamed to restrictBrowserNavigation
            .booleanAttribute("preserveLastState", true, "When true the use of browser navigation buttons will be restricted.")
