...
//        wizardData.setAgeField(true);
        ...
        final WizardVideoAudioOptionStimulusScreen list1234Screen = new WizardVideoAudioOptionStimulusScreen("VideoAudioOption", false, stimuliString, true, new String[]{"list_2"}, 1000, true, 100, "", "", "volgende [ spatiebalk ]");
