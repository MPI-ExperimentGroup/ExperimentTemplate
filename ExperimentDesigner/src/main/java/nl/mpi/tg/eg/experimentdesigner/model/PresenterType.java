...
public enum PresenterType {
    ...
    transmission(new FeatureType[]{
        ...
        localStorageData,
        allMetadataFields, metadataFieldConnection, metadataField, metadataFieldVisibilityDependant, metadataFieldDateTriggered, saveMetadataButton, createUserButton, switchUserIdButton, selectUserMenu,
        existingUserCheck,
