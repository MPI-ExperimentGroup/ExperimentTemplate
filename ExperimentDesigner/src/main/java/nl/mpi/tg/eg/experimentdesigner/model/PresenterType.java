...
public enum PresenterType {
    ...
    transmission(new FeatureType[]{
        ...
        logTimerValue,
        //        logTokenText, 
        serverValueAssign, serverValueComplete, 
        actionTokenButton,
        clearPage,
        ...
        localStorageData, stimuliValidation, addKeyboardDebug, addDebugWidgets, uploadUsersDataMenu,
        ...
        zeroStimulusStopwatch, stopStimulusStopwatch, endAudioRecorderTag, startAudioRecorderApp, startAudioRecorderWeb, audioInputSelectWeb, videoInputSelectWeb, targetFooterButton, actionFooterButton,
        //        popupMessage,
        stimulusAudio,
        stimulusImage,
        //        clearStimulus,
    ...
    metadata(new FeatureType[]{
        ...
        // redirectToUrl, 
        sendAllData, regionRecordStart, regionRecordStop,
        ...
        userInfo,
        menuItem,
        zeroStimulusStopwatch, stopStimulusStopwatch, endAudioRecorderTag, startAudioRecorderApp, startAudioRecorderWeb, audioInputSelectWeb, videoInputSelectWeb,
        //        targetFooterButton, actionFooterButton
    }),
    preload(new FeatureType[]{
        logTimeStamp, hardwareTimeStamp, dtmfTone, recorderToneInjection, logTokenText, 
        serverValueAssign, serverValueComplete, 
        actionTokenButton, habituationParadigmListener, triggerRandom, resetTrigger, addMediaTrigger,
        ...
        eraseLocalStorageButton, eraseUsersDataButton,
        validateMetadata, transmitResults, generateCompletionCode,
        redirectToUrl, sendAllData, regionRecordStart, regionRecordStop,
        eraseLocalStorageOnWindowClosing,
        allMenuItems,
        nextStimulusButton,
        ratingFooterButton, ratingButton, ratingRadioButton, ratingCheckbox, stimulusRatingButton, stimulusRatingRadio, stimulusRatingCheckbox,
    ...
    colourPicker(new FeatureType[]{
        ...
        gotoNextPresenter,
        timerLabel, startTimer, clearTimer, logTimerValue, logTokenText, 
        serverValueAssign, serverValueComplete, 
        actionTokenButton, compareTimer, habituationParadigmListener, triggerRandom, resetTrigger,
        ...
        startAudioRecorderApp, startAudioRecorderWeb, audioInputSelectWeb, videoInputSelectWeb, stopAudioRecorder, startAudioRecorderTag, endAudioRecorderTag,
        loadKinTypeStringDiagram, localStorageData, stimuliValidation, addKeyboardDebug, addDebugWidgets, uploadUsersDataMenu,
        //        loadStimulus, 
    ...
    kindiagram(new FeatureType[]{
        ...
        prevStimulusButton,
        prevStimulus, timerLabel, startTimer, compareTimer, habituationParadigmListener, triggerRandom, resetTrigger, clearTimer, logTimerValue, 
        logTokenText, serverValueAssign, 
        serverValueComplete, actionTokenButton,
        clearPage,
        resetStimulus,
        playMedia,
        rewindMedia,
    ...
    debug(new FeatureType[]{
        ...
        randomMsPause, evaluatePause, addTimerTrigger, triggerDefinition, addMediaTrigger, addRecorderDtmfTrigger, addRecorderLevelTrigger,triggerMatching, countdownLabel, stimulusPresent, clearCurrentScore,
        prevStimulusButton,
        prevStimulus, timerLabel, startTimer, compareTimer, habituationParadigmListener, triggerRandom, resetTrigger, clearTimer, logTimerValue, logTokenText, 
        serverValueAssign, serverValueComplete, 
        actionTokenButton,
        clearPage,
        resetStimulus,
        ...
        zeroStimulusStopwatch, stopStimulusStopwatch, endAudioRecorderTag, startAudioRecorderApp, startAudioRecorderWeb, audioInputSelectWeb, videoInputSelectWeb, targetFooterButton, actionFooterButton,
        validateMetadata, transmitResults, generateCompletionCode,
        redirectToUrl, sendAllData, regionRecordStart, regionRecordStop, eraseUsersDataButton,
        eraseLocalStorageOnWindowClosing,
        //        clearStimulus,
        /*removeStimulus,*/ removeMatchingStimulus, withMatchingStimulus, nextMatchingStimulus,
        keepStimulus,
    ...
    text(new FeatureType[]{
        ...
        displayCompletionCode,
        sendMetadata, prevStimulusButton,
        prevStimulus, timerLabel, startTimer, habituationParadigmListener, triggerRandom, resetTrigger, clearTimer, logTimerValue, logTokenText, 
        serverValueAssign, serverValueComplete, 
        actionTokenButton,
        //        hasGetParameter,
        showColourReport, submitTestResults, helpDialogue,
    ...
    timeline(new FeatureType[]{
        ...
        timerLabel, startTimer, compareTimer, habituationParadigmListener, triggerRandom, resetTrigger, clearTimer, logTimerValue, logTokenText, 
        serverValueAssign, serverValueComplete, 
        actionTokenButton,
        stimulusMetadataField,
        cancelPauseTimers,
