...
public enum PresenterType {
    ...
    transmission(new FeatureType[]{
        versionData,
        randomMsPause, evaluatePause, addTimerTrigger, triggerDefinition, addMediaTrigger, triggerMatching, countdownLabel, stimulusPresent,
        prevStimulusButton,
        prevStimulus, timerLabel, startTimer, compareTimer, habituationParadigmListener, triggerRandom, resetTrigger, clearTimer, 
        logTimerValue, 
//        logTokenText, 
        actionTokenButton,
        clearPage,
        sendGroupStoredMessage, sendGroupTokenMessage,
        showStimuliReport,
        ...
        endAudioRecorderTag, startAudioRecorderApp, startAudioRecorderWeb, audioInputSelectWeb, targetFooterButton, actionFooterButton,
        //        popupMessage,
        stimulusAudio,
        stimulusImage,
        //        clearStimulus,
        ...
        //        autoNextStimulus,
        addKinTypeGui,
        logTimeStamp, hardwareTimeStamp,
        audioButton,
        preloadAllStimuli,
    ...
    metadata(new FeatureType[]{
        ...
        randomMsPause, evaluatePause, addTimerTrigger, triggerDefinition, addMediaTrigger, triggerMatching,
...
//        actionTokenButton,
        ...
        userInfo,
        menuItem,
        endAudioRecorderTag, startAudioRecorderApp, startAudioRecorderWeb, audioInputSelectWeb, 
//        targetFooterButton, actionFooterButton
    }),
    preload(new FeatureType[]{
        logTimeStamp, hardwareTimeStamp, logTokenText, actionTokenButton, habituationParadigmListener, triggerRandom, resetTrigger,
        versionData,
    ...
    colourPicker(new FeatureType[]{
        ...
        countdownLabel, triggerMatching, table, triggerDefinition, addMediaTrigger, touchInputCaptureStart, column,
        stimulusMetadataField,
...
//        targetFooterButton, actionFooterButton,
    ...
    kindiagram(new FeatureType[]{
        activateRandomItem,
        versionData,
        randomMsPause, evaluatePause, addTimerTrigger, triggerDefinition, addMediaTrigger, triggerMatching, countdownLabel, stimulusPresent, clearCurrentScore,
        prevStimulusButton,
    ...
    menu(new FeatureType[]{
        ...
        progressIndicator, htmlTokenText, stimulusButton,
        touchInputStimulusButton, touchInputCaptureStart,
        touchInputReportSubmit,
        stimulusHasResponse,
        showColourReport, submitTestResults, helpDialogue,
...
//        onSuccess,
    ...
    text(new FeatureType[]{
        ...
        //        htmlTokenText,
        versionData,
        randomMsPause, evaluatePause, addTimerTrigger, triggerDefinition, addMediaTrigger, triggerMatching, stimulusButton, logTimeStamp, hardwareTimeStamp, touchInputStimulusButton, activateRandomItem, countdownLabel, stimulusPresent, playMedia,
        rewindMedia,
        pauseMedia, logMediaTimeStamp,
        clearCurrentScore,
        resetStimulus,
        clearPage, showStimuliReport,
        sendStimuliReport, logTimeStamp, hardwareTimeStamp, touchInputCaptureStart, touchInputReportSubmit,
...
//        hasGetParameter,
    ...
    timeline(new FeatureType[]{
        sendStimuliReport,
        activateRandomItem,
        triggerDefinition, addMediaTrigger, randomMsPause, evaluatePause, addTimerTrigger, triggerMatching,
        ...
        clearPage,
        prevStimulusButton,
        requestNotification, hasMetadataValue, setMetadataValue, setMetadataEvalTokens, matchOnEvalTokens, progressIndicator, htmlTokenText, logTimeStamp, hardwareTimeStamp, showStimuliReport, stimulusButton, touchInputStimulusButton, sendMetadata, prevStimulus,
        ...
        cancelPauseTimers,
        displayCompletionCode,
        stimulusHasResponse, touchInputReportSubmit, logTimeStamp, hardwareTimeStamp, touchInputCaptureStart,
        showColourReport, submitTestResults, helpDialogue,
        submitGroupEvent, groupMemberActivity, groupNetwork, groupMemberCodeLabel, groupMemberLabel, groupMessageLabel, groupResponseStimulusImage,
        groupResponseFeedback, groupScoreLabel, groupChannelScoreLabel, groupMemberActivity, groupNetwork, groupMemberCodeLabel, groupMemberLabel,
        groupMessageLabel, groupResponseStimulusImage, groupResponseFeedback, scoreLabel, scoreIncrement, scoreAboveThreshold, bestScoreAboveThreshold, totalScoreAboveThreshold,
