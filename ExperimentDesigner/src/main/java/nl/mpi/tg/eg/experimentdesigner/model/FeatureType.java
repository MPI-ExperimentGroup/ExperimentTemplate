...
public enum FeatureType {
    ...
    pause(true, false, new FeatureAttribute[]{msToNext}, "Pause in milliseconds. When the time is up the contents of this element are evaluated."),
