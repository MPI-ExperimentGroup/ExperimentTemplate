...
public enum FeatureType {
    ...
    startAudioRecorderWeb(false, new FeatureAttribute[]{downloadPermittedWindowMs, deviceRegex, mediaId}, "Starts the audio recorder, the HTML5 audio recorder will be used unless the value of recordingFormat is wav in which case the Android wav recorder wil be used. If the Android wav recorder is used then the wav files will be saved on the device in a sub directory based on value of the provided metadata field.", Contitionals.hasMediaRecorderPlayback, Contitionals.stimulusAction),
    startAudioRecorderApp(false, new FeatureAttribute[]{filePerStimulus, eventTag, fieldName}, "Starts the audio recorder, the HTML5 audio recorder will be used unless the value of recordingFormat is wav in which case the Android wav recorder wil be used. If the Android wav recorder is used then the wav files will be saved on the device in a sub directory based on value of the provided metadata field.", Contitionals.hasErrorSuccess, Contitionals.stimulusAction),
