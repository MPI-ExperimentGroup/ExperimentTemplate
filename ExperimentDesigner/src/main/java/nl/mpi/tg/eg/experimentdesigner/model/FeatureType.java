...
public enum FeatureType {
    ...
    audioInputSelectWeb(false, false, new FeatureAttribute[]{deviceRegex, styleName}, "Shows a select box of the available audio input devices for use with startAudioRecorderWeb. When an device is selected it will be used as the first preference when the next recording is made."),
