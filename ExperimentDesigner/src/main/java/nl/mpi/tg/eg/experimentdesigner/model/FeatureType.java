...
public enum FeatureType {
    ...
    clearStimulusResponses(new FeatureAttribute[]{}, true, "Clears all locally stored responses to all stimulus that have all the supplied tags. Stimulus that do not have ALL the provided tags will not be affected.", Contitionals.none, Contitionals.none),
    ...
    sendGroupMessageButton(true, new FeatureAttribute[]{hotKey, dataChannel, eventTag, repeatIncorrect, incrementPhase, styleName, groupId/* incrementPhaseOnDictionaryincrementStimulus */}, "Adds a button that will send a message to the goup members that are in the current member's communication channel. The message content is the concatonated values of all freetext inputs currently in the presenter. If any freetext input is not valid then the relevant freetext input will show an error and the message will not be sent.", Contitionals.none, Contitionals.groupNetworkAction),
    sendGroupMessage(false, new FeatureAttribute[]{eventTag, incrementPhase /*, incrementStimulus */}, "Sends a message to the goup members that are in the current member's communication channel. The contents of the message is the last message received in the current users communication channel.", Contitionals.none, Contitionals.groupNetworkAction),
    sendGroupStoredMessage(false, new FeatureAttribute[]{eventTag, incrementPhase /*, incrementStimulus */, groupId}, "Sends a message to the goup members that are in the current member's communication channel. The message is the stored value of groupId for current stimulus. If groupId is not provided 'groupMessage' will be used. If the is no stored value then an empty message will be sent.", Contitionals.none, Contitionals.groupNetworkAction),
