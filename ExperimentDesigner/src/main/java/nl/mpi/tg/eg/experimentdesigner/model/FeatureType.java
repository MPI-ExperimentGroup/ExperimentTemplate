...
public enum FeatureType {
    ...
    transmitResults(false, new FeatureAttribute[]{receivingRegex, sendingRegex, dataLogFormat}, "Transmits the values of the metadata fields that match the matchingRegex to the endpoint defined in registrationUrlStaging and registrationUrlProduction (listing.json), the metadata fields which match the enabledRegex will be updated if there is such a field returned from that service.", Contitionals.hasErrorSuccess, Contitionals.none);
