...
public enum FeatureType {
    ...
    clearTimer(false, false, new FeatureAttribute[]{listenerId}, "Clears the start time of a persistent timer matching listenerId (from the local storage data). A subsequent startTimer with the same listenerId can be used to assign a new start time."), // does this also clear the timer listeners?
