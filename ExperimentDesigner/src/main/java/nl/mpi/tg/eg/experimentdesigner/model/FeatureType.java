...
public enum FeatureType {
    ...
    // TODO: it should be clearer to the user that the hotKey in stimulusFreeText will trigger any button with the same hotkey
    stimulusFreeText(true, new FeatureAttribute[]{validationRegex, dataChannel, allowedCharCodes, hotKey, styleName, inputErrorMessage, groupId}, false, false, false, Contitionals.none, Contitionals.stimulusAction),
