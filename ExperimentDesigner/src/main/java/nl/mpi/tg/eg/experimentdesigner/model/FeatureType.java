...
public enum FeatureType {
    ...
    groupNetwork(false, new FeatureAttribute[]{groupMembers, groupCommunicationChannels, groupCameraChannels, groupAudioChannels, groupCanvasChannels, phasesPerStimulus}, "Connects a group of participants so that they can interact in a defined manner during the experiment. For each stimulus there is a number of phases which is determined by phasesPerStimulus.", Contitionals.groupNetwork, Contitionals.groupStimulus),
    ...
    updateGroupStream(false, new FeatureAttribute[]{eventTag, streamState, streamTypes}, "Update the streaming state for the current group phase members.", Contitionals.none, Contitionals.groupNetworkAction),
