...
public enum FeatureType {
    ...
    addRecorderDtmfTrigger(false, new FeatureAttribute[]{dtmf}, "Adds a web recorder event that will trigger when the the provided DTMF tone is detected in the recorded audio stream. Only one trigger can be assigned per DTMF code.", Contitionals.isTimeCritical, Contitionals.isTimeCritical, Contitionals.none),
