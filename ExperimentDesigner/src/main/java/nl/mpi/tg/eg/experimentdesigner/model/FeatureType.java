...
public enum FeatureType {
    ...
    regionStyle(false, new FeatureAttribute[]{regionId, styleName}, "The region matching the regionId will have the style applied. If no region matching the regionId exists then a new region is created in the current location.", Contitionals.none, Contitionals.none, Contitionals.isTimeCritical),
    regionCodeStyle(false, new FeatureAttribute[]{regionId, styleName}, "Applies the style to the region matching the regionId, the styleName will have any tokens evaluated before the resulting style name is applied to the region. If no region matching the regionId exists then a new region is created in the current location.", Contitionals.none, Contitionals.stimulusAction),
    ...
    regionClear(false, false, new FeatureAttribute[]{regionId}, "If a region matching the regionId exists then it will cleared. If no region matching the regionId exists then a new region is created in the current location. Unlike clearPage clearing a region only removes the visual components, so any media that has been placed in the region should be stopped first."),
