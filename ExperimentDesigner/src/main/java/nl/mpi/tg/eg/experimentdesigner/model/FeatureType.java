...
public enum FeatureType {
    ...
    image(false, false, new FeatureAttribute[]{percentOfPageWidth, maxHeight, maxWidth, src, link}),
    ...
    stimulusImage(true, false, new FeatureAttribute[]{percentOfPageWidth, maxHeight, maxWidth, timeToNext}),
    stimulusCodeImage(true, false, new FeatureAttribute[]{percentOfPageWidth, maxHeight, maxWidth, timeToNext, codeFormat}),
    stimulusAudio(true, false, new FeatureAttribute[]{timeToNext, mp3,}),
    VideoPanel(false, false, new FeatureAttribute[]{mp4, ogg, webm, percentOfPageWidth, maxHeight, maxWidth, poster}),
