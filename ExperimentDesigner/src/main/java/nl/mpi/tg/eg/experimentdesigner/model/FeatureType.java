...
public enum FeatureType {
    ...
    loadStimulus(false, false, new FeatureAttribute[]{eventTag, maxStimuli, randomise, norepeat}, true, false),
    loadAllStimulus(false, false, new FeatureAttribute[]{eventTag, randomise, norepeat}, true, false),
    ...
    nextStimulusButton(false, true, new FeatureAttribute[]{eventTag}),
    autoNextStimulus(false, false, new FeatureAttribute[]{eventTag}),
