...
public enum FeatureType {
    ...
    zeroStimulusStopwatch(false, new FeatureAttribute[]{eventId}, "Each stimulus response can have a number of stimulus time periods recorded. At the point when the time period should start the named period should be zeroed.", Contitionals.none, Contitionals.none, Contitionals.stimulusAction, Contitionals.isTimeCritical),
    // zeroStimulusStopwatch or zeroStimulusTimeCounter
    stopStimulusStopwatch(false, new FeatureAttribute[]{eventId}, "Each stimulus response can have a number of stimulus time periods recorded. At the point when the time period should end the named period should be stopped.", Contitionals.none, Contitionals.none, Contitionals.stimulusAction, Contitionals.isTimeCritical),
