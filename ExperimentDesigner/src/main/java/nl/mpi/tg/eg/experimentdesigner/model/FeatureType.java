...
public enum FeatureType {
    ...
    ratingCheckboxes(false, false, new FeatureAttribute[]{dataChannel, ratingLabels, ratingLabelLeft, ratingLabelRight, orientation, styleName, groupId}, false, false, false, Contitionals.none, Contitionals.stimulusAction),
    ...
    stimulusRatingRadio(false, false, new FeatureAttribute[]{dataChannel, ratingLabelLeft, ratingLabelRight, orientation, styleName}, false, false, false, Contitionals.none, Contitionals.stimulusAction),
    stimulusRatingCheckbox(false, false, new FeatureAttribute[]{dataChannel, ratingLabelLeft, ratingLabelRight, orientation, styleName}, false, false, false, Contitionals.none, Contitionals.stimulusAction),
