...
public enum FeatureType {
    ...
    touchInputStop(false, new FeatureAttribute[]{dataChannel}, "Stops the touch input capture and submits the logged touch input of the participant since touch input capture was started and then stops the input capture which then triggers captureEnd. This action is implicit but this feature allows the capture to be terminated early.", Contitionals.none, Contitionals.touchInputStartType),
