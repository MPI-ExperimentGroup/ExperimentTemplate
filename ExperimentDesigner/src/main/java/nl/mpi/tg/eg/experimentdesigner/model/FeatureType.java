...
public enum FeatureType {
    ...
    regionRecordStart(false, new FeatureAttribute[]{regionId}, "If a region matching the regionId exists then its contents will be recorded and stored on the server simular to audio recordings. Recordings will be 15fps and stored in 5-10 second long sections. If no matching region exists then nothing will be done.", Contitionals.hasErrorSuccess, Contitionals.stimulusAction),
    regionRecordStop(false, new FeatureAttribute[]{regionId}, "If a region matching the regionId exists and is being recorded then that recording will be stopped. If no matching region exists then nothing will be done.", Contitionals.none, Contitionals.stimulusAction),
