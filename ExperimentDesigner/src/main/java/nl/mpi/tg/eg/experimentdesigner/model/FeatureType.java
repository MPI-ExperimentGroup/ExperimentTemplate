...
public enum FeatureType {
    ...
    loadStimulus(false, false, new FeatureAttribute[]{eventTag, maxStimuli, randomise, repeatCount, repeatRandomWindow}, true, true, Contitionals.hasMoreStimulus),
    ...
    loadSdCardStimulus(false, false, new FeatureAttribute[]{eventTag, maxStimuli, randomise, repeatCount, repeatRandomWindow}, true, false, Contitionals.hasMoreStimulus),
    ...
    sendGroupMessage(false, false, new FeatureAttribute[]{incrementPhase}),
    ...
    // todo: metadataFieldConnection(false, false, new FeatureAttribute[]{fieldName}),
