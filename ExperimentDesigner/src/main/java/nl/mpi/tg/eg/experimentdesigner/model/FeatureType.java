...
public enum FeatureType {
    ...
    stimulusImage(true, false, new FeatureAttribute[]{maxHeight, maxWidth, timeToNext}),
    stimulusCodeImage(true, false, new FeatureAttribute[]{maxHeight, maxWidth, timeToNext, codeFormat}),
