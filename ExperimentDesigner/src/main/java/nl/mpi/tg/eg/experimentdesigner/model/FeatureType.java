...
public enum FeatureType {
    ...
    groupNetwork(false, new FeatureAttribute[]{groupMembers, /* can we remove groupCommunicationChannels by replacing it with an equivalent of streamChannels eg messageChannels, groupCameraChannels, groupAudioChannels, groupCanvasChannels,*/ phasesPerStimulus}, "Connects a group of participants so that they can interact in a defined manner during the experiment. For each stimulus there is a number of phases which is determined by phasesPerStimulus.", Contitionals.groupNetwork, Contitionals.groupStimulus),
