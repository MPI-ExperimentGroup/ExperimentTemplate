...
public enum FeatureType {
    ...
    updateGroupStream(false, new FeatureAttribute[]{eventTag, streamState, streamType}, "Update the streaming state for the current group phase members.", Contitionals.none, Contitionals.groupNetworkAction),
