...
stopSharingDetailsExplanation=({0}) and unique id ({1})
    ...
    <xsl:template match="saveMetadataButton[@featureText != '']|createUserButton[@featureText != '']|targetButton[@featureText != '']|actionButton[@featureText != '']|text[@featureText != '']|popupMessage[@featureText != '']|menuItem[@featureText != '']|featureText[@featureText != '']|nextStimulusButton[@featureText != '']|htmlText[@featureText != '']|userInfo[@featureText != '']">
