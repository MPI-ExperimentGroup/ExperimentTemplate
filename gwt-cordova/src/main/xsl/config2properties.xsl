...
stopSharingDetailsExplanation=({0}) and unique id ({1})
    ...
    <xsl:template match="targetButton[@featureText != '']|actionButton[@featureText != '']|text[@featureText != '']|popupMessage[@featureText != '']|menuItem[@featureText != '']|featureText[@featureText != '']|nextStimulusButton[@featureText != '']|htmlText[@featureText != '']|conditionalHtml[@featureText != '']|userInfo[@featureText != '']">
