...
#labelCounter=1;
makeLabel() {
    convert -gravity center -size 128x128 -background black -fill white -font /Library/Fonts/Arial\ Black.ttf -pointsize 60 label:"$1" "$1.png"
    echo "<stimulus code=\"$1\" identifier=\"$1\" label=\"$1\" tags=\"Labels\"/>"
