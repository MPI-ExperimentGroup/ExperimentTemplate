    ...
    private native void handleOffer(final String messageData, final String stunServer, Integer originPhase, String userId, String groupId, String groupUUID, String memberCode, String screenId) /*-{
        ...
        if ($wnd.peerConnection) {
            ...
            $wnd.handleOffer($wnd.peerConnection, offer, function (answer) {
                    groupStreamHandler.@nl.mpi.tg.eg.experiment.client.service.GroupStreamHandler::messageGroup(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)("answer", "{ type: 'answer', sdp: '" + JSON.stringify(answer.sdp) + "' }", originPhase, userId, groupId, groupUUID, memberCode, screenId);
                }, function(error) {
                ...
                if (groupId !== contentData.groupId) {
                    ...
                    if ($wnd.peerConnection) {
                        ...
                        $wnd.createOffer($wnd.peerConnection,
                            function(offer) {
                                groupStreamHandler.@nl.mpi.tg.eg.experiment.client.service.GroupStreamHandler::messageGroup(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)("offer", "{ type: 'offer', sdp: '" + JSON.stringify(offer.sdp) + "' }", originPhase, userId, groupId, groupUUID, memberCode, screenId);
                            }, function(error) {
                                console.log(error.message);
                                groupStreamHandler.@nl.mpi.tg.eg.experiment.client.service.GroupStreamHandler::disconnectStreams(Ljava/lang/Integer;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)(originPhase, userId, groupId, groupUUID, memberCode, screenId);
                            }
