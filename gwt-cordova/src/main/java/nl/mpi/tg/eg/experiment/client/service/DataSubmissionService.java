...
//        boolean staticFilesUrlOk = serviceLocations.staticFilesUrl().contains("ems12");
    ...
    public native void submitMediaData(final Uint8Array dataBlob, final MediaSubmissionListener mediaSubmissionListener, final Double partNumber) /*-{
        ...
        xhr.onload = function() {
            if(xhr.readyState === 4) {
                if(xhr.status === 200) {
                    var replayMediaUrl = URL.createObjectURL(dataBlob);
                    ...
                    mediaSubmissionListener.@nl.mpi.tg.eg.experiment.client.listener.MediaSubmissionListener::submissionComplete(Ljava/lang/String;Ljava/lang/String;)(xhr.responseText, replayMediaUrl);
                } else {
