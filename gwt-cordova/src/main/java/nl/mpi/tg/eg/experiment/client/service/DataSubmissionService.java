        ...
        xhr.onload = function() {
            if(xhr.readyState === 4) {
                if(xhr.status === 200) {
                    ...
                    mediaSubmissionListener.@nl.mpi.tg.eg.experiment.client.listener.MediaSubmissionListener::submissionComplete(Ljava/lang/String;Lcom/google/gwt/typedarrays/shared/Uint8Array;)(xhr.responseText, dataBlob);
                } else {
