                ...
                $wnd.requestPermissions(true, true, videoDeviceRegex, audioDeviceRegex, videoWidth, videoHeight,
                    function(recordingStream) {
                        ...
                        $wnd.mediaRecorder.onstop = function(e) {
                            ...
                            dataSubmissionService.@nl.mpi.tg.eg.experiment.client.service.DataSubmissionService::submitMediaData(Lcom/google/gwt/typedarrays/shared/Uint8Array;Lnl/mpi/tg/eg/experiment/client/listener/MediaSubmissionListener;Ljava/lang/Double;)(videoRecorderBlob, mediaSubmissionListener, 0);
                            $wnd.videoRecorderChunks = [];
                            if (videoElement) {
