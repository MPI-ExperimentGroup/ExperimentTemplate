    ...
    &lt;body&gt;
        &lt;span th:fragment="participanttable" class="table-container" id="participanttable"&gt;
            &lt;script th:inline="javascript"&gt;
                ...
                generateTable({divId: "participanttable", label: "Participant Data", source: "participantdata", columnNames: "
                    /*[[${simpleMode} ? '' : 'id,staleCopy,userId,userAgent,acceptLang,']]*/
                "</xsl:text>
                <xsl:for-each select="experiment/metadata/field">
                    <xsl:value-of select="@postName" />
                    <xsl:if test="position() != last()">
                ...
                <xsl:text>,submitDate", userId: paramId
