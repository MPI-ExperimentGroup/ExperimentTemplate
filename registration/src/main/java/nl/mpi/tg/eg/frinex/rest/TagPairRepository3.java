...
/**
 * @since Aug 2, 2018 11:19:36 AM (creation date)
 * @author Peter Withers <peter.withers@mpi.nl>
 */
@RepositoryRestResource(collectionResourceRel = "tagpair3", path = "tagpair3")
public interface TagPairRepository3 extends PagingAndSortingRepository<TagPairData, Long> {
