...
//    List<TagPairData> findByEventTag(@Param("eventTag") String eventTag);
    ...
    @Query("select count distinct new TagPairData(userId, screenName, dataChannel, eventTag, tagValue1, tagValue2, eventMs, tagDate) from TagPairData order by tagDate asc")
