...
import nl.mpi.tg.eg.frinex.adaptivevocabularyassessment.client.service.ravenpool.*;
...
//   
    public String parseWordsInputCSVStringToXml(String csvString, String stimuliDir) throws Exception {
        ...
        for (LinkedHashMap<String, String> record : records) {
            ...
            currentSt.append(" audioPath=\"").append(stimuliDir).append(soundFile).append("\" ");
            currentSt.append(" tags=\"").append(block).append(" ").append(duration).append(" ").append(condition).append(" ").append("\" ");
