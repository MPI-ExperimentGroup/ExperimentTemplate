...
public class TrialTest {
    ...
    public void testGetStimuli() {
        ...
        assertEquals(TestConfigurationConstants.STIMULI_DIR+"clear_mono/kem_1", result.get(0).getStimulus().getAudio());
        assertEquals(TestConfigurationConstants.STIMULI_DIR + Indices.BAND_LABEL_TO_DIRNAME.get(this.trial2.getBandLabel()) + "/guil_-6", result.get(1).getStimulus().getAudio());
        assertEquals(TestConfigurationConstants.STIMULI_DIR + Indices.BAND_LABEL_TO_DIRNAME.get(this.trial2.getBandLabel()) + "/kedlim_-6", result.get(2).getStimulus().getAudio());
        assertEquals(TestConfigurationConstants.STIMULI_DIR + Indices.BAND_LABEL_TO_DIRNAME.get(this.trial2.getBandLabel()) + "/sorbuin_-6", result.get(3).getStimulus().getAudio());
        assertEquals(TestConfigurationConstants.STIMULI_DIR + Indices.BAND_LABEL_TO_DIRNAME.get(this.trial2.getBandLabel()) + "/kem_2_-6", result.get(4).getStimulus().getAudio());
        assertEquals(TestConfigurationConstants.STIMULI_DIR + Indices.BAND_LABEL_TO_DIRNAME.get(this.trial2.getBandLabel()) + "/vep_-6", result.get(5).getStimulus().getAudio());
        ...
        assertEquals(TestConfigurationConstants.STIMULI_DIR+"clear_mono/" + cue.getLabel(), cue.getAudio());
        for (int i = 1; i < this.trial1.getStimuli().size(); i++) {
            ...
            assertEquals(TestConfigurationConstants.STIMULI_DIR + Indices.BAND_LABEL_TO_DIRNAME.get(bandLabel) + "/" + filename, stimulus.getAudio());
        }
        ...
        assertEquals(TestConfigurationConstants.STIMULI_DIR+"clear_mono/" + cue3.getLabel(), cue3.getAudio());
